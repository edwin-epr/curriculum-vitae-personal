...
\CVItemizeStart
\CVitem{Completó 84 de 72 créditos requeridos.}
%\CVitem{Opté por no titularme, enfocándome en la adquisición de conocimientos y habilidades prácticas durante el programa de maestría.}
\CVItemizeEnd
...
\CVListStart
\CVSubHeading{\small Técnico Académico Asociado C}{Febrero 2024 - a la fecha}{ENES Mérida UNAM}{Yucatán, México}
\CVItemizeStart
...
\CVSubHeading{\small Profesor de Matemáticas}{Agosto 2022 - Diciembre 2022}{NUMERALIA}{Tabasco, México}
\CVItemizeStart
...
%\end{multicols}
%\CVItemizeEnd
\CVSubHeading{Sistemas Operativos que se utilizar:}{}{}{}
\vspace{-15pt}
\CVItemizeStart
\begin{multicols}{3}
	\CVitem{Linux}
