...
\CVItemizeStart
\CVitem{Apoyo en el desarrollo de programas de cómputo paralelo, con especial énfasis en nuevas tecnologías y lenguajes de programación. Auxilio en la instalación y/o ejecución de software de simulación científica de alto rendimiento. Asisto en el manejo del control de versiones Git para el desarrollo de programas en esquema colaborativo.}
\CVItemizeEnd
