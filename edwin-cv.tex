...
\CVItemizeStart
	\CVitem{Apoyo en el desarrollo de programas de simulación numérica de altas prestaciones y a utilizar nuevas tecnologías en el cómputo científico, en concreto, a trabajar con unidades gráficas de procesamiento.}
	\CVitem{Desarrollo de scripts automatizados en Python o MATLAB para la recuperación de datos de modelación numérica en metrología, oceanografía y áreas afines, almacenados en servidores web.}
	\CVitem{Auxilio en la instalación y/o ejecución de software de simulación científica de alto rendimiento.}
	\CVitem{Asisto en el manejo del control de versiones Git para el desarrollo de programas en esquema colaborativo.}
\CVItemizeEnd
